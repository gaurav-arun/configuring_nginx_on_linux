...
```
We have added proxy with the `proxy_pass` directive. This comes from `ngx_http_proxy_module`. Refer [docs](https://nginx.org/en/docs/http/ngx_http_proxy_module) for more info. 
